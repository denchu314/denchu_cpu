...
`define	EXCEPTION_CODE_HARD_BITS	4
`define	EXCEPTION_CODE_SOFT_BITS	4

`define	EXCEPTION_CODE_HARD_NONE	{`EXCEPTION_CODE_HARD_BITS + `EXCEPTION_CODE_SOFT_BITS}'h00
`define	EXCEPTION_CODE_HARD_RESET	{`EXCEPTION_CODE_HARD_BITS + `EXCEPTION_CODE_SOFT_BITS}'h01	
`define	EXCEPTION_CODE_HARD_TIMER	{`EXCEPTION_CODE_HARD_BITS + `EXCEPTION_CODE_SOFT_BITS}'h02
`define	EXCEPTION_CODE_HARD_KEYBOARD	{`EXCEPTION_CODE_HARD_BITS + `EXCEPTION_CODE_SOFT_BITS}'h03
`define	EXCEPTION_CODE_HARD_ETHERNET	{`EXCEPTION_CODE_HARD_BITS + `EXCEPTION_CODE_SOFT_BITS}'h04
`define	EXCEPTION_CODE_HARD_IO		{`EXCEPTION_CODE_HARD_BITS + `EXCEPTION_CODE_SOFT_BITS}'h05
`define	EXCEPTION_CODE_SOFT_NONE	{`EXCEPTION_CODE_HARD_BITS + `EXCEPTION_CODE_SOFT_BITS}'h00
`define	EXCEPTION_CODE_SOFT_ZERODIV	{`EXCEPTION_CODE_HARD_BITS + `EXCEPTION_CODE_SOFT_BITS}'h10
`define	EXCEPTION_CODE_SOFT_OVERFLOW	{`EXCEPTION_CODE_HARD_BITS + `EXCEPTION_CODE_SOFT_BITS}'h20
`define	EXCEPTION_CODE_SOFT_UNDERFLOW	{`EXCEPTION_CODE_HARD_BITS + `EXCEPTION_CODE_SOFT_BITS}'h30
`define	EXCEPTION_CODE_SOFT_TRAP	{`EXCEPTION_CODE_HARD_BITS + `EXCEPTION_CODE_SOFT_BITS}'h40

`define	INTR_FORBID	1
`define	INTRING		1
